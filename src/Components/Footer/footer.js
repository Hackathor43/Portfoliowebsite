    ...
    return(
        <section className="Footer-main">
            <div className="Footer-social">
                <div>
                    <a href="https://www.linkedin.com/in/ganesh-hemanth-5a78a0138/" target="_blank">
                    <img className="Footer-img" src='./img/linkedin.svg' alt="LinkedIn Logo"></img>
                    </a>
                </div>
                <div>
                <a href="https://github.com/Hackathor43" target="_blank">
                    <img className="Footer-img" src='./img/github.svg' alt="Github Logo"></img>
                    </a>
                </div>
                <div>
                <a href="https://twitter.com/ghemanth43" target="_blank"> 
